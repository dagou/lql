...
from ast import (SelectNode, IdentifierNode, WhereNode, UnaryOpNode, BinOpNode, NumberNode, StringNode, OrderNode, LimitNode)
...
class Parser(object):
    ...
    def fields(self):
        nodes = [self.field()]
        while self.current_token.token_type != TokenType.T_EOF and self.current_token.token_type == TokenType.T_COMMA:
